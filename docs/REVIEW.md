...
The tool can be triggered automatically every time a new PR is [opened](https://github.com/khulnasoft/mergemate/blob/main/Usage.md#github-app-automatic-tools), or can be invoked manually by commenting on any PR:
```
/review
```
For example:
___
<kbd><img src=https://khulnasoft.com/images/mergemate/review_comment.png width="768"></kbd>
___
<kbd><img src=https://khulnasoft.com/images/mergemate/review.png width="768"></kbd>
___

### Configuration options

To edit [configurations](./../mergemate/settings/configuration.toml#L19)  related to the review tool (`pr_reviewer` section), use the following template:
```
...
<kbd><img src=https://khulnasoft.com/images/mergemate/incremental_review.png width="768"></kbd>

Under the section 'pr_reviewer', the [configuration file](./../mergemate/settings/configuration.toml#L19) contains options to customize the 'review -i' tool.  
...
<kbd><img src=https://khulnasoft.com/images/mergemate/reflection_questions.png width="768"></kbd>
___
<kbd><img src=https://khulnasoft.com/images/mergemate/reflection_answers.png width="768"></kbd>
___
<kbd><img src=https://khulnasoft.com/images/mergemate/reflection_insights.png width="768"></kbd>
___
...
### Automation
- When you first install the app, the [default mode](https://github.com/khulnasoft/mergemate/blob/main/Usage.md#github-app-automatic-tools) for the `review` tool is:
```
pr_commands = ["/review", ...]
```
...
- a `possible security issue` label that detects a possible [security issue](https://github.com/khulnasoft/mergemate/blob/tr/user_description/mergemate/settings/pr_reviewer_prompts.toml#L136) (`enable_review_labels_security` flag)
