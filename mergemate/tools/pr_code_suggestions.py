...
from mergemate.algo.pr_processing import get_pr_diff, get_pr_multi_diffs, retry_with_fallback_models
from mergemate.algo.token_handler import TokenHandler
from mergemate.algo.utils import load_yaml, replace_code_tags, ModelType
...
class PRCodeSuggestions:
    def __init__(self, pr_url: str, cli_mode=False, args: list = None,
        ...
        self.progress += f"""\nWork in progress ...<br>\n<img src="https://khulnasoft.com/images/mergemate/dual_ball_loading-crop.gif" width=48>"""
