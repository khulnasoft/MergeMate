...
class GitProvider(ABC):
    ...
    def get_user_description(self) -> str:
        ...
        # if the existing description wasn't generated by the mergemate, just return it as-is
        if not self._is_generated_by_mergemate(description_lowercase):
            get_logger().info(f"Existing description was not generated by the mergemate")
            return description

        # if the existing description was generated by the mergemate, but it doesn't contain a user description,
        # return nothing (empty string) because it means there is no user description
        user_description_header = "## **user description**"
        if user_description_header not in description_lowercase:
            get_logger().info(f"Existing description was generated by the mergemate, but it doesn't contain a user description")
            return ""

        # otherwise, extract the original user description from the existing mergemate description and return it
    ...
    def _possible_headers(self):
        return ("## **user description**", "## **pr type**", "## **pr description**", "## **pr labels**", "## **type**", "## **description**",
                "## **labels**", "### 🤖 generated by merge mate")

    def _is_generated_by_mergemate(self, description_lowercase: str) -> bool:
        possible_headers = self._possible_headers()
