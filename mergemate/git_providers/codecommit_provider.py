...
from mergemate.git_providers.codecommit_client import CodeCommitClient
...
class CodeCommitProvider(GitProvider):
    ...
    def get_pr_id(self):
        ...
        Note: This is an internal identifier for MergeMate, 
    ...
    def get_repo_settings(self):
        # a local ".mergemate.toml" settings file is optional
        settings_filename = ".mergemate.toml"
